	...
	internal static class RenderTargetContext
	{
        ...
        private static RenderTargetSetup[] _mrtBindingsLegacy = new RenderTargetSetup[6]
        {
            ...
            (
                ...
                new RenderBufferStoreAction[1]{RenderBufferStoreAction.DontCare},
            ...
            (
                ...
                new RenderBufferStoreAction[2]{RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare},
                RenderBufferLoadAction.DontCare, RenderBufferStoreAction.DontCare
            )
            #if UNITY_2018_3_OR_NEWER
            { depthSlice = -1 }
            ...
            (
                ...
                new RenderBufferStoreAction[3]{RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare},
                RenderBufferLoadAction.DontCare, RenderBufferStoreAction.DontCare
            )
            #if UNITY_2018_3_OR_NEWER
            { depthSlice = -1 }
            ...
            (
                ...
                new RenderBufferStoreAction[4]{RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare},
                RenderBufferLoadAction.DontCare, RenderBufferStoreAction.DontCare
            )
            #if UNITY_2018_3_OR_NEWER
            { depthSlice = -1 }
            ...
            (
                ...
                new RenderBufferStoreAction[5]{RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare},
                RenderBufferLoadAction.DontCare, RenderBufferStoreAction.DontCare
            )
            #if UNITY_2018_3_OR_NEWER
            { depthSlice = -1 }
            ...
            (
                ...
                new RenderBufferStoreAction[6]{RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare, RenderBufferStoreAction.DontCare},
                RenderBufferLoadAction.DontCare, RenderBufferStoreAction.DontCare
            )
            #if UNITY_2018_3_OR_NEWER
            { depthSlice = -1 }
