	...
	HEADER
	{
		UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(o);
			...
			/*
				...
				bloom = DownsampleHQ(PASS_TEXTURE_2D(_SourceTex, sampler_SourceTex), BLOOM_UV, SOURCE_TEXEL_SIZE);
			#else
			...
			*/
			...
			glare0 = SampleTex2D(PASS_TEXTURE_2D(_SourceTex, sampler_SourceTex), GLARE_UV);
